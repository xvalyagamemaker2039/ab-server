...
export default class GamePlayersConnect extends System {
  ...
  onCreatePlayer({ connectionId, name, flag, horizon, userId }): void {
     ...
     * Welcome messages.
     */
    this.sendWelcomeMessage(playerId, uniqueName);
  ...
  private sendWelcomeMessage(playerId: PlayerId, name: string): void {
